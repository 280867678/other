...
public class HistoryListAdapter extends RecyclerView.Adapter<HistoryListAdapter.ViewHoder> {
    private List<VideoInfo> list = new ArrayList<>();
    private Context context;

    public HistoryListAdapter(List<VideoInfo> videoList, Context context){
        this.list = videoList;
    ...
    public ViewHoder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = View.inflate(parent.getContext(), R.layout.item_play_history, null);
    ...
    public void onBindViewHolder(@NonNull ViewHoder holder, @SuppressLint("RecyclerView") int position) {
        VideoInfo news = list.get(position);
        Glide.with(context).load(news.path)
        ...
        holder.constraintLayout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                intent.putExtra("videoList", GsonUtils.toJson(list));
