...
//    }
    ...
    public static void appendDetails(StringBuilder sb, Object object, int maxElements) {
        if (object != null && object.getClass().isArray()) {
            ...
            while (true) {
                if (i >= length) {
                    ...
                    appendDetails(sb, Array.get(object, i), maxElements);
                    i++;
                }
            }
            sb.append(']');
            ...
            while (true) {
                ...
                int i3 = i2 + 1;
                if (i2 == maxElements) {
                    sb.append(" (").append(coll.size() - i3).append(" more)");
                    break;
                }
                if (first) {
                    first = false;
                ...
                appendDetails(sb, element, maxElements);
                i2 = i3;
            }
            sb.append(']');
        } else {
