...
//    public static final Comparator<String> CASE_INSENSITIVE_NUMRIC_ORDER = new Comparator<String>() { // from class: com.mxtech.text.StringUtils.1
...
//    }
//
//    public static boolean containsAnyOf(CharSequence seq, char[] search) {
//        return indexAnyOf(seq, search) < 0;
//    }
//
...
//    }
//
//    public static String formatCurl(String str, Map<String, String> values, boolean keepNotMapped) {
//        return format(str, values, "{", "}", keepNotMapped);
//    }
//
