...
import com.mxtech.videoplayer.lite.App;
...
//    private OnSubtitleEnabledListener _onSubtitleEnabledListener;
    ...
    public static final String TAG = "MX/J" + ".FF";
...
//            setDataSource(context, this._fd.getFileDescriptor(), this._fd.getStartOffset(), this._fd.getLength());
        ...
        setDataSource(context, ffmpegPathFrom(uri), headersText, userAgent, cookies);
    }
    ...
    public IMediaInfo info() {
        IMediaInfo info = new IMediaInfo() { // from class: com.mxtech.media.FFPlayer.1
            ...
            public Locale[] locales() {
                ...
                return (langs == null || langs.length() == 0 || "und".equalsIgnoreCase(langs)) ? new Locale[0] : LocaleUtils.parseLocales(langs);
            }
...
//    /* JADX INFO: Access modifiers changed from: private */
    ...
    private class StreamInfo implements IStreamInfo {
        ...
        @Override // com.mxtech.media.IMediaInfo
        public int width() {
            return _rot90 ? getStreamHeight(this.index) : getStreamWidth(this.index);
        }

        @Override // com.mxtech.media.IMediaInfo
        public int height() {
            return _rot90 ? getStreamWidth(this.index) : getStreamHeight(this.index);
        }

        @Override // com.mxtech.media.IMediaInfo
        public int displayWidth() {
            return _rot90 ? getStreamDisplayHeight(this.index) : getStreamDisplayWidth(this.index);
        }

        @Override // com.mxtech.media.IMediaInfo
        public int displayHeight() {
            return _rot90 ? getStreamDisplayWidth(this.index) : getStreamDisplayHeight(this.index);
        }

        @Override // com.mxtech.media.IStreamInfo
        public int type() {
            return getStreamType(this.index);
        }

        @Override // com.mxtech.media.IStreamInfo
        public int disposition() {
            return getStreamDisposition(this.index);
        }

        @Override // com.mxtech.media.IMediaInfo
        public String format() {
            return getStreamCodec(this.index);
        }

        @Override // com.mxtech.media.IStreamInfo
        public String profile() {
            return getStreamProfile(this.index);
        }

        @Override // com.mxtech.media.IStreamInfo
        public int frameTime() {
            return getStreamFrameTime(this.index);
        }

        @Override // com.mxtech.media.IStreamInfo
        public int bitRate() {
            return getStreamBitRate(this.index);
        }

        @Override // com.mxtech.media.IStreamInfo
        public int sampleRate() {
            return getStreamSampleRate(this.index);
        }

        @Override // com.mxtech.media.IStreamInfo
        public long channelLayout() {
            return getStreamChannelLayout(this.index);
        }

        @Override // com.mxtech.media.IStreamInfo
        public int channelCount() {
            return getStreamChannelCount(this.index);
        }
    }
...
//            int codecIndex = FFPlayer.getSubtitleCodecIndex(getStreamCodecId(stream));
//            this._isWebVTT = codecIndex == 17;
//            this._outputType = outputType;
//            this._best = best;
//            if (outputType == 3) {
//                _subClient.getSubStationAlphaMedia(2, FFPlayer.this);
//            }
//            int flags = 65536;
...
//            String lang = getStreamMetadata(stream, 102, ios3lang);
//            String name = getStreamMetadata(stream, 7, ios3lang);
...
//                name = StringUtils.getString_s(R.string.name_by_track, Integer.valueOf(_subTrackSequence));
//            }
//            this._name = name;
...
//            return isSupportedSubtitleTrack(this._nativeTrack);
//        }
//
//        @Override // com.mxtech.subtitle.ISubtitle
...
//            setSubtitleTranslation(sync, speed);
//        }
//
//        /* JADX INFO: Access modifiers changed from: package-private */
...
//                _subClient.setupFonts(false);
//            }
//            try {
//                enableSubtitleTrack(this._stream, enable);
//                if (_onSubtitleEnabledListener != null) {
//                    _onSubtitleEnabledListener.onSubtitleEnabled(FFPlayer.this, this, enable);
//                }
...
//            return updateSubtitle(this._nativeTrack, pos);
//        }
//
//        @Override // com.mxtech.subtitle.ISubtitle
//        public int previous() {
//            return previousSubtitle(this._nativeTrack);
//        }
//
//        @Override // com.mxtech.subtitle.ISubtitle
//        public int next() {
//            return nextSubtitle(this._nativeTrack);
//        }
//
...
//            Object content = getSubtitleFrames(this._nativeTrack);
