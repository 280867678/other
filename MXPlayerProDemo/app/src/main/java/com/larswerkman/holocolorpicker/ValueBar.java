...
public class ValueBar extends View {
    ...
    public ValueBar(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
    ...
    private void init(AttributeSet attrs, int defStyleAttr, int defStyleRes) {
        TypedArray a = getContext().obtainStyledAttributes(attrs, R.styleable.ColorBars, defStyleAttr, defStyleRes);
    ...
    protected void onSizeChanged(int w, int h, int oldw, int oldh) {
        ...
        if (!isInEditMode()) {
            this.shader = new LinearGradient(this.mBarPointerHaloRadius, 0.0f, x1, y1, new int[]{Color.HSVToColor(255, this.mHSVColor), ViewCompat.MEASURED_STATE_MASK}, (float[]) null, Shader.TileMode.CLAMP);
        } else {
            this.shader = new LinearGradient(this.mBarPointerHaloRadius, 0.0f, x1, y1, new int[]{-8257792, ViewCompat.MEASURED_STATE_MASK}, (float[]) null, Shader.TileMode.CLAMP);
    ...
    public float getValueResolution() {
        return this.mPosToSatFactor;
    }

    public void setPointerHaloColor(int color) {
        this.mBarPointerHaloPaint.setColor(color);
        invalidate();
    }

    public int getPointerHaloColor() {
        return this.mBarPointerHaloPaint.getColor();
    }
    ...
    public void setColor(int color) {
        ...
        this.shader = new LinearGradient(this.mBarPointerHaloRadius, 0.0f, x1, y1, new int[]{color, ViewCompat.MEASURED_STATE_MASK}, (float[]) null, Shader.TileMode.CLAMP);
        this.mBarPaint.setShader(this.shader);
    ...
    protected Parcelable onSaveInstanceState() {
        ...
        float[] hsvColor = new float[3];
        Color.colorToHSV(this.mColor, hsvColor);
        state.putFloat("value", hsvColor[2]);
        return state;
    }
    ...
    protected void onRestoreInstanceState(Parcelable state) {
        ...
        setValue(savedState.getFloat("value"));
    }
}
