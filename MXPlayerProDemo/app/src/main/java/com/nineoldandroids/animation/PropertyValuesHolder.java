...
public class PropertyValuesHolder implements Cloneable {
    ...
    static class IntPropertyValuesHolder extends PropertyValuesHolder {
        ...
        @Override // com.nineoldandroids.animation.PropertyValuesHolder
        /* renamed from: clone */
        public IntPropertyValuesHolder mo10clone() {
            IntPropertyValuesHolder newPVH = (IntPropertyValuesHolder) super.mo10clone();
    ...
    static class FloatPropertyValuesHolder extends PropertyValuesHolder {
        ...
        @Override // com.nineoldandroids.animation.PropertyValuesHolder
        /* renamed from: clone */
        public FloatPropertyValuesHolder mo10clone() {
            FloatPropertyValuesHolder newPVH = (FloatPropertyValuesHolder) super.mo10clone();
