...
public abstract class AppCompatTwoStatePreference extends AppCompatPreference {
    ...
    @TargetApi(21)
    public AppCompatTwoStatePreference(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
        super(context, attrs, defStyleAttr, defStyleRes);
    }

    public AppCompatTwoStatePreference(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
    }

    public AppCompatTwoStatePreference(Context context, AttributeSet attrs) {
    ...
    public static class SavedState extends Preference.BaseSavedState {
        public static final Parcelable.Creator<SavedState> CREATOR = new Parcelable.Creator<SavedState>() { // from class: com.mxtech.preference.AppCompatTwoStatePreference.SavedState.1
