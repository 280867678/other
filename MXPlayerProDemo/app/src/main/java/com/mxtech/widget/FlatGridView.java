...
public class FlatGridView extends GridView {
    ...
    public FlatGridView(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        this._ensuredPosition = -1;
    }

    @SuppressLint({"NewApi"})
    public FlatGridView(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
