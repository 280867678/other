...
public class ValueBar2 extends ValueBar {
    ...
    public ValueBar2(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context, attrs, 0, 0);
    }

    public ValueBar2(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        init(context, attrs, defStyleAttr, 0);
    }

    public ValueBar2(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
    ...
    private void change(boolean increase, KeyEvent event) {
        ...
        if (event.getAction() == 0) {
            ...
            change(delta * getValueResolution());
        }
    }
