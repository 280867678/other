...
public class Model {
    ...
    public static final int GALAXY_NOTE_10_1_2014_EU = 43;
    ...
    private static final String _GALAXY_NOTE_10_1_2014_EU = "SM-P600";
            ...
            switch (Build.MANUFACTURER.charAt(0)) {
                ...
                case 'a':
                    if ("asus".equalsIgnoreCase(Build.MANUFACTURER)) {
                        manufacturer = ASUS;
                        break;
                    } else if ("Acer".equalsIgnoreCase(Build.MANUFACTURER)) {
                        manufacturer = ACER;
                        break;
                    } else if ("archos".equalsIgnoreCase(Build.MANUFACTURER)) {
                        manufacturer = ARCHOS;
                        break;
                    } else if ("ainol".equalsIgnoreCase(Build.MANUFACTURER)) {
                        manufacturer = AINOL;
                        break;
                    }
                    break;
                ...
                case 's':
                    if ("samsung".equalsIgnoreCase(Build.MANUFACTURER)) {
                        manufacturer = 10000;
                        break;
                    } else if ("Sony".equalsIgnoreCase(Build.MANUFACTURER) || "Sony Ericsson".equalsIgnoreCase(Build.MANUFACTURER)) {
                        manufacturer = SONY;
                        break;
                    }
                    break;
            ...
            switch (Build.MODEL.charAt(0)) {
                case 'A':
                    if (_TF300T.equals(Build.MODEL) && manufacturer == 10110) {
                        model = 242;
                        break;
                    } else if (_TF700T.equals(Build.MODEL) && manufacturer == 10110) {
                        model = TF700T;
                        break;
                    } else if ("A500".equals(Build.MODEL) && manufacturer == 10010) {
                        model = ICONIA_500_SERIES;
                        break;
                    } else if (_ARCHOS_70.equals(Build.MODEL) && manufacturer == 10030) {
                        model = 70;
                        break;
                    }
                    break;
                case 'D':
                    if (_HTC_DESIRE_HD.equals(Build.MODEL)) {
                        model = 1001;
                        break;
                    } else if (_DELL_VENUE.equalsIgnoreCase(Build.MODEL)) {
                        model = DELL_VENUE;
                        break;
                    }
                    break;
                ...
                case 'G':
                    if (Build.MODEL.startsWith(_GALAXY_S)) {
                        model = 10;
                        break;
                    } else if (Build.MODEL.startsWith(_GALAXY_S2)) {
                        model = 20;
                        break;
                    } else if (Build.MODEL.startsWith(_GALAXY_NOTE)) {
                        model = 40;
                        break;
                    } else if (Build.MODEL.startsWith(_GALAXY_ACE)) {
                        model = 50;
                        break;
                    } else if (Build.MODEL.equalsIgnoreCase(_GALAXY_GIO)) {
                        model = 52;
                        break;
                    } else if (_GALAXY_NEXUS.equals(Build.MODEL)) {
                        model = 30;
                        break;
                    }
                    break;
                case 'H':
                    if (_HTC_ONE1.startsWith(Build.MODEL) || _HTC_ONE2.startsWith(Build.MODEL)) {
                        model = HTC_ONE;
                        break;
                    } else if (_HTC_DESIRE.equals(Build.MODEL)) {
                        model = 1000;
                        break;
                    } else if (_EVO_4G_PLUS.equals(Build.MODEL)) {
                        model = EVO_4G_PLUS;
                        break;
                    } else if (_HTC_DESIRE_200.startsWith(Build.MODEL)) {
                        model = 1004;
                        break;
                    } else if (_HTC_DESIRE_300.startsWith(Build.MODEL)) {
                        model = 1005;
                        break;
                    } else if (_HTC_DESIRE_400.startsWith(Build.MODEL)) {
                        model = 1006;
                        break;
                    } else if (_HTC_DESIRE_500.startsWith(Build.MODEL)) {
                        model = 1007;
                        break;
                    } else if (_HTC_DESIRE_600.startsWith(Build.MODEL)) {
                        model = 1008;
                        break;
                    } else if (_HTC_DESIRE_700.startsWith(Build.MODEL)) {
                        model = 1009;
                        break;
                    } else if (_HTC_DESIRE_S.startsWith(Build.MODEL)) {
                        model = 1010;
                        break;
                    } else if (_HTC_DESIRE_V.startsWith(Build.MODEL)) {
                        model = 1011;
                        break;
                    } else if (_HTC_DESIRE_U.startsWith(Build.MODEL)) {
                        model = 1012;
                        break;
                    } else if (_HTC_DESIRE_X.startsWith(Build.MODEL)) {
                        model = 1013;
                        break;
                    } else if (_HTC_DESIRE_C.startsWith(Build.MODEL)) {
                        model = 1014;
                        break;
                    } else if (_HTC_BUTTERFLY.startsWith(Build.MODEL)) {
                        model = HTC_BUTTERFLY;
                        break;
                    }
                    break;
                case 'I':
                    if (manufacturer == 10100) {
                        if (Build.MODEL.startsWith(_VEGA_RACER2)) {
                            model = VEGA_RACER2;
                            break;
                        } else if (Build.MODEL.startsWith(_VEGA_S5)) {
                            model = VEGA_S5;
                            break;
                        } else if (Build.MODEL.startsWith(_VEGA_R3)) {
                            model = VEGA_R3;
                            break;
                        } else if (Build.MODEL.startsWith(_VEGA_NO6)) {
                            model = VEGA_NO6;
                            break;
                        }
                    }
                ...
                case 'K':
                    if (_KINDLE_FIRE.equals(Build.MODEL)) {
                        model = KINDLE_FIRE;
                        break;
                    } else if (manufacturer == 10080 && _TAKE_LTE.equals(Build.MODEL)) {
                        model = 200;
                        break;
                    } else if (manufacturer == 10140 && Build.MODEL.contains(_STUTTGART)) {
                        model = STUTTGART;
                        break;
                    }
                    break;
                case 'L':
                    if (Build.MODEL.startsWith(LG_PREFIX)) {
                        String name = Build.MODEL.substring(LG_PREFIX.length());
                        if (name.startsWith(_OPTIMUS_ONE) || name.indexOf(_OPTIMUS_ONE_KR) >= 0) {
                            model = OPTIMUS_ONE;
                            break;
                        } else if (name.startsWith(_OPTIMUS_G2) || name.startsWith(_OPTIMUS_G2_KR)) {
                            model = OPTIMUS_G2;
                            break;
                        }
                    } else if (manufacturer == 10140 && Build.MODEL.contains(_STUTTGART)) {
                ...
                case 'M':
                    if (Build.MODEL.startsWith(_XOOM)) {
                        model = 90;
                        break;
                    } else if (Build.MODEL.equals(_MX2) && manufacturer == 10120) {
                        model = 250;
                        break;
                    } else if (Build.MODEL.equals(_MK808B) && manufacturer == 10090) {
                        model = MK808B;
                        break;
                    } else if (Build.MODEL.equals(_MI3)) {
                        model = MI3;
                        break;
                    } else if (Build.MODEL.equals(_MI3W)) {
                        model = MI3W;
                        break;
                    }
                    break;
                case 'N':
                    if (_NEXUS_S.equals(Build.MODEL)) {
                        model = 60;
                        break;
                    } else if (_NEXUS_ONE.equals(Build.MODEL)) {
                        model = 61;
                        break;
                    } else if (_NOVO7_PALADIN.equals(Build.MODEL)) {
                        model = NOVO7_PALADIN;
                        break;
                    }
                    break;
                case 'S':
                    if (Build.MODEL.startsWith(_GALAXY_S_KR) || Build.MODEL.equals(_GALAXY_S_VIBRANT)) {
                        model = 10;
                        break;
                    } else if (Build.MODEL.startsWith(_GALAXY_S2_KR)) {
                        model = 20;
                        break;
                    } else if (Build.MODEL.startsWith(_GALAXY_S2_LTE_KR) || Build.MODEL.startsWith(_GALAXY_S2_LTEHD_KR)) {
                        model = 21;
                        break;
                    } else if (Build.MODEL.startsWith(_GALAXY_NOTE_KR)) {
                        model = 40;
                        break;
                    } else if (Build.MODEL.startsWith(_GALAXY_ACE_KR)) {
                        model = 50;
                        break;
                    } else if (Build.MODEL.startsWith(_GALAXY_A_KR)) {
                        model = 51;
                        break;
                    } else if (Build.MODEL.startsWith(_GALAXY_GIO_KR)) {
                        model = 52;
                        break;
                    } else if (Build.MODEL.equals(_GALAXY_NOTE_LTE)) {
                        model = 41;
                        break;
                    } else if (Build.MODEL.equals(_GALAXY_NOTE4_N910A)) {
                        model = 42;
                        break;
                    } else if (Build.MODEL.equals(_GALAXY_NOTE_10_1_2014_EU)) {
                        model = 43;
                        break;
                    }
                    break;
                case 'T':
                    if (_TF101.equals(Build.MODEL) && manufacturer == 10110) {
                        model = TF101;
                        break;
                    } else if (_TF201.equals(Build.MODEL) && manufacturer == 10110) {
                        model = TF201;
                        break;
                    }
                    break;
                ...
                case 'W':
                    if ("W500".equals(Build.MODEL) && manufacturer == 10010) {
                        model = ICONIA_500_SERIES;
                        break;
                    } else if (_WXG_7F29.equals(Build.MODEL)) {
                        model = 80;
                        break;
                    }
                    break;
